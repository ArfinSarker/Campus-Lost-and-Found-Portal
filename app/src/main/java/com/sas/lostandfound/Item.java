...
public class Item {
    ...
    // Found Item Specific
    private String itemHandlingStatus; // Kept with finder, Submitted to authority, etc.
    ...
    private String adminStatus; // Pending, Matched, Returned, Expired, Suspended
    ...
    // Simplified constructor for common fields
    ...
    public Item(String id, String name, String location, String time, String status, String userId) {
        this.id = id;
        this.name = name;
        this.location = location;
        this.time = time;
